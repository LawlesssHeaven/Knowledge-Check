    ...
    describe('Answers Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Answers', () => {
                service.create(new Answers(null)).subscribe(received => {
            ...
            it('should update a Answers', () => {
                service.update(new Answers(123)).subscribe(received => {

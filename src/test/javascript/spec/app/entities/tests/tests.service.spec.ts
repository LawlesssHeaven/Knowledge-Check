...
describe('Service Tests', () => {
    describe('Tests Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TestsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tests';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tests', () => {
                service.create(new Tests(null)).subscribe(received => {
            ...
            it('should update a Tests', () => {
                service.update(new Tests(123)).subscribe(received => {
